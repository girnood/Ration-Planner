...
exports.DispatcherModule = DispatcherModule = __decorate([
    (0, common_1.Module)({
        imports: [providers_module_1.ProvidersModule, orders_module_1.OrdersModule, pricing_module_1.PricingModule],
        providers: [dispatcher_service_1.DispatcherService, dispatcher_gateway_1.DispatcherGateway],
